...
def client_handler(conn, addr):
    ...
    try:
        while True:
            ...
            elif msg == 101: # move (Save Position)
...
print(f"GAME SERVER 9555 READY (v16 PERSISTENT)");

    ...
    try:
        while True:
            ...
            if msg == 4: # login
                ...
                rt = tags.get(msg); res = encode_sproto([(0, {}) if rt in [645,642,643,674,646,648,688,630,656,542,689,684] else (0,[]) if rt in [598] else (0,0) if rt in [647,623] else (0,0,1,0) if rt in [606] else []])
